...
export class MovieListComponent {
  ...
  deleteMovies(movie : Movie){
    const index = this.movieService.movieData.indexOf(movie);
    if( index != -1){
      this.movieService.movieData.splice(index,1);
    }
  }
}
